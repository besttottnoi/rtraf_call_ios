...
class LoginViewController: UIViewController, UITextFieldDelegate, NetParamsControllerDelegate {
    ...
    override func viewDidLoad() {
        ...
        labelDebugInfo.text = "PortSIP VoIP SDK for iOS V" + portSIPSDK.getVersion()

        transPortItems = ["UDP", "TLS", "TCP"]
        ...
        btTrans.tag = UserDefaults.standard.integer(forKey: "kTRANSPORT")
        labelTrans.text = transPortItems[btTrans.tag]
        doAutoRegister()
    }
...
//    }
    ...
    func onLine() {
        ...
        UserDefaults.standard.set(btTrans.tag, forKey: "kTRANSPORT")
        ...
        let rt = portSIPSDK.setLicenseKey("PORTSIP_TEST_LICENSE")
        ...
        if state == UIApplication.State.background {
            ...
            if rt == ECoreTrialVersionLicenseKey {
                /*
                 showAlterViewWith(title:"Warning",message:"This trial version SDK just allows short conversation, you can't heairng anyting after 2-3 minutes, contact us: sales@portsip.com to buy official version.");*/
                ...
                showAlterViewWith(title: "Error", message: "The wrong license key was detected, please check with sales@portsip.com or support@portsip.com")
                NSLog("setLicenseKey failure ErrorCode = %d", rt)
                return
            } else if rt == ECoreTrialVersionExpired {
                showAlterViewWith(title: "Error", message: "This trial version SDK has expired, please download new version at http://www.portsip.com/downloads.html")
                NSLog("setLicenseKey failure ErrorCode = %d", rt)
                return
            }
        }
    ...
    @objc func refreshRegister() {
        ...
        case LOGIN_STATUS.LOGIN_STATUS_OFFLINE:
            // Not Register
            break;
        case LOGIN_STATUS.LOGIN_STATUS_LOGIN:
            // is registering
            break;
        case LOGIN_STATUS.LOGIN_STATUS_ONLINE:
            ...
            break;
        case LOGIN_STATUS.LOGIN_STATUS_FAILUE:
    ...
    func onRegisterSuccess(_: CInt, withStatusText statusText: String) {
        ...
        sipRegistrationStatus = LOGIN_STATUS.LOGIN_STATUS_ONLINE
        autoRegisterRetryTimes = 0
        return
    }
